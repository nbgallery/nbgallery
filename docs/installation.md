...
NOTE: This is just provded for reference.  The [development container setup](docs/docker.md) should be used as this is not officially supported anymore.  Only Ubuntu is listed as that was the only environment readily available to update the documentation.
