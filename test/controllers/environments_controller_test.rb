...
class EnvironmentsControllerTest < ActionController::TestCase
  ...
  test 'should create environment' do
    assert_difference('Environment.count') do
      post :create, environment: { default: @environment.default, name: @environment.name, url: @environment.url, user_id: @environment.user_id }
    end
  ...
  test 'should update environment' do
    patch :update, id: @environment, environment: { default: @environment.default, name: @environment.name, url: @environment.url, user_id: @environment.user_id }
    assert_redirected_to environment_path(assigns(:environment))
  end
